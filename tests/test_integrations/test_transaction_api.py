...
class TestTransactionApi:
    ...
    def test_non_json_error_responses(self):
        ...
        for endpoint, func in get_endpoints:
            ...
            # The transaction_api functions now handle JSON decode errors properly
            # They will raise a proper Exception with HTTP status code info
        ...
        with pytest.raises(Exception, match="HTTP error! status: 502"):
